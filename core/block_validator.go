...
// the gas allowance.
func CalcGasLimit(parentGasUsed, parentGasLimit, minGasLimit, gasFloor, gasCeil uint64) uint64 {
...
func CalcGasLimit1559(parentGasLimit, minGasLimit, desiredLimit uint64) uint64 {
